...
/**
 * @desc component containing home titles managing birth animation and language
 */
@Component({})
export default class YHomeTitle extends Vue {
  private languageData = LanguageManager.languageData.homeData;
