 ...
 */
 export class ProjectsLanguageData {
  ...
  public noProjectsMessage : string = "";
}

/**
 * @desc data format for articles
 */
export class ArticleLanguageData {
  public projectType = "Projet";
  public publishedOn = "Publié le ";
  public updatedOn = "Mis à jour le ";
